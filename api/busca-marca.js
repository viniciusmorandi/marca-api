// /api/busca-marca.js
// [ADD] Retry exponencial, User-Agent rotativo, Micro-cache, Playwright seguro
...
// === VARIÁVEIS E FUNÇÕES DE CACHE, UTILITÁRIOS E UA ===
const USER_AGENTS = [
...
// === SCRAPER #2: (Playwright com UA + FEATURE FLAG) ===
    ...
    if (!resultado || !Array.isArray(resultado.processos)) {
      try {
        ...
        if (e.message === 'PLAYWRIGHT_DISABLED') {
          // Fallback seguro, nunca retorna 500 à toa
